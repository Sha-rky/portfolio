...
// -------------------------------------------------------------------------
// Dark-mode counterpart to v7's light-mode window — see that file for the
// citypop-light.css palette this one is paired against.
// =========================================================================
const Version6WindowDemo = () => {
    return (
        <div className="space-y-10 py-6 max-w-4xl mx-auto">
            <div className="text-center space-y-2 mb-8">
                {/* Was bg-window-shadow/border-window-shadow/text-window-shadow,
                    a custom property never defined in the registry — the badge
                    rendered colourless. Pinned to the dark theme's own accent. */}
                <div className="inline-block px-3 py-1 rounded bg-[#ff85c2]/20 border border-[#ff85c2] text-[#ff85c2] font-mono text-xs font-semibold">
                    UNIFIED CONTENT SPEC // 1. Image ➔ 2. Title ➔ 3. Description ➔ 4. Tags
                </div>
                <h3 className="font-cyberpunk text-2xl text-white">Standardized Terminal Window — Dark</h3>
